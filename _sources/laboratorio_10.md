...
```
Si noti che questo implica che il numero di iterazioni necessarie ad avere un errore assoluto minore di una fissata tolleranza $\varepsilon$ è $k\geq \log_2(|b-a|\varespilon^{-1})$.
